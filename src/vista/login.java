...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtUsuario.setFont(new java.awt.Font("Fira Code", 1, 14)); // NOI18N
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        modelo.setLas_session(fechaHora.toString());
        
        String pass = new String(txtPassword.getPassword());
        
        if(!txtUsuario.getText().equals("") && !pass.equals("")){
            String nuevoPas = Hash.sha1(pass);
            modelo.setUsuario(txtUsuario.getText());
            modelo.setPassword(nuevoPas);
            modelo.setLas_session(fechaHora.format(date));
            
            if(modSql.login(modelo)){
